...
|23/04/26| 10:15 | Model order reduction | [Notes](/notes/2026-04-23-Note-11-17.pdf) [Notebook](/codes/ROM_with_FEniCS.ipynb) | https://uniroma1.zoom.us/rec/share/BIQ0xcjwlXE4GZEsTK-yylFnSGrlGAYBHxudshCDCKq4ue0BORpLQWhwHGkOiGg.hYAuwqTUhEIlxjRQ | 8JT%*t#1 |
...
|:-----|:------|:---------|:-----------|:-----------|
|31/03/26| Finite difference for Poisson | [Notebook](/codes/poisson_FD.ipynb) | [Solutions](/codes/solutions/poisson_FD.ipynb)|
|16/04/26| Finite element 1D for Poisson | [Notebook](/codes/poisson_FEM.ipynb) | [Solutions](/codes/solutions/poisson_FEM.ipynb)| |
|22/04/26| Finite element 2D for Poisson with FEniCS| [Notebook](/codes/FEM_with_FEniCS.ipynb) |[Solutions](/codes/solutions/FEM_with_FEniCS.ipynb)|
|23/04/26| Reduced order models for parametric problems with FEniCS| [Notebook](/codes/ROM_with_FEniCS.ipynb) |-|
|29/04/26| Finite difference for Heat equation | [Notebook](/codes/heat_FD.ipynb) | [Solutions](/codes/solutions/heat_FD.ipynb)|
...
1. WENO reconstruction for finite difference for transport equation in 1D
